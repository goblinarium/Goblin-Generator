const data = {
    familial: ["$son", "O'$", "Mc$", "$ovich", "$dotter", "$stein", "$", "$le"],
    name: [
        "Sam",
        "Smork",
        "Dave",
    ...
    template: ["@adjective @race @class from @location who @backstory"],
    ...
    race: [
        ...
        "croid presenting",
        "beldrin presenting",
        "l'laamosa presenting",
        "rham presenting",
        "bones",
        "enormous chitterling",
    ],

    class: [
        "Greasy Wizard Man",
        "Lil Stabby",
        "Sweet Baby Cinnamon Roll, How did you get such bad friends",
        "Bard",
        "Fancy Wizard Man",
        "Smasho",
    ],
    ...
    signs: ["Mook", "Fook", "Piss", "Dirt", "Libra", "Oblin"],
    auger: [
        "Tinker (touch)",
        "True Auger (sight)",
        "Licker (taste)",
    ...
    skillLevels: [
        "So poor as to make this character a danger to themseleves and those around them",
        "toddlerish",
        "not ideal",
